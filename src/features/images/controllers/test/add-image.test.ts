...
import { imagesMockRequest, imagesMockResponse, nextFn } from '@root/mocks/image.mock';
...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    it('should call image upload method', async () => {
      ...
      await Add.prototype.profileImage(req, res, nextFn);
  ...
  describe('backgroundImage', () => {
    it('should upload new image', async () => {
      ...
      await Add.prototype.backgroundImage(req, res, nextFn);
    ...
    it('should return bad request error', async () => {
      ...
      Add.prototype.backgroundImage(req, res, nextFn).catch((error: CustomError) => {
