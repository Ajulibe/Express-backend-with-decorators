...
export class Update {
  ...
  public async postWithImage(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  public async postWithVideo(req: Request, res: Response, next: NextFunction): Promise<void> {
