...
import { postMockData, postMockRequest, postMockResponse, updatedPost, updatedPostWithImage, nextFn } from '@root/mocks/post.mock';
...
describe('Update', () => {
  ...
  describe('postWithImage', () => {
    it('should send correct json response if imgId and imgVersion exists', async () => {
      ...
      await Update.prototype.postWithImage(req, res, nextFn);
